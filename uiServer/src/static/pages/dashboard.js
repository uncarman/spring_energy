define(function (require) {
    ...
    app.controller('dashboard', ['$scope', '$state', '$stateParams', function($scope, $state, $stateParams) {
        ...
        $scope.datas = {
            ...
            subTypeName: settings.subTypes["能耗分项"],
        }
        ...
        $scope.getDatas = function () {
            $scope.ajaxBuildingList()
                ...
                .then($scope.buildItemWarningData)
        ...
        $scope.buildItemWarningData = function(res) {
            $scope.$apply(function(){
                $scope.datas.result.warningList = res.data;
            });
        }
