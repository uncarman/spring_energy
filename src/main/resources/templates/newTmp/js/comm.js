...
var settings = {
    ...
    ajax_func: {
        ...
        "ajaxGetUserBuildings": "ajax/getUserBuildings", // 用户下所有建筑

        "ajaxGetBuildingSummaryData": "ajax/getBuildingSummaryData", // 获取某个建筑的汇总数据

        "ajaxGetItemGroups": "ajax/getItemGroups", // 获取所有分组列表
        "ajaxGetItemsByGroupId": "ajax/getItemsByGroupId",  // 获取某个分组下的所有设备
        "ajaxRemoveItemGroup": "ajax/removeItemGroup",  // 删除
        "ajaxUpdateItemGroup": "ajax/updateItemGroup",  // 更新
        "ajaxCreateItemGroup": "ajax/createItemGroup",  // 创建

        "ajaxGetItems": "ajax/getItems",  // 所有设备
        "ajaxRemoveItem": "ajax/removeItem",  // 删除
        "ajaxUpdateItem": "ajax/updateItem",  // 更新
        "ajaxCreateItem": "ajax/createItem",  // 创建

        "ajaxGetBaseDatas": "ajax/getBaseDatas", // 基础数据
        "ajaxRemoveBaseDatas": "ajax/removeBaseDatas",  // 删除
        "ajaxUpdateBaseDatas": "ajax/updateBaseDatas",  // 更新
        "ajaxCreateBaseDatas": "ajax/createBaseDatas",  // 创建
    },
...
var global = {
    ...
    check_logined: function () {
        ...
        if(typeof user != "undefind" && typeof user["id"] != "undefined" && user["id"] > 0) {
            // pass
        } else {
